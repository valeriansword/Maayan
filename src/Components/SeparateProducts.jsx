    ...
    <div className='mb-[20px]'>
        {
            products.map((prod,index)=>(
                <div key={index} >
                 ...
                 <div className='grid grid-cols-3 gap-[20px] mx-[20px] max-sm:grid-cols-1'>
                 { prod.Separateproducts.map((sep)=>(
                     <div key={sep.id} className='text-[#dad7cd] bg-[#3a5a40] rounded-md p-2'>
                        <img src={sep.image} className='h-[200px] object-fit w-full rounded-md '/>
